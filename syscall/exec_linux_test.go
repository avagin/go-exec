...
package syscall2_test

import (
	"flag"
	"fmt"
	"github.com/avagin/go-exec/os/exec"
	syscall2 "github.com/avagin/go-exec/syscall"
	"io"
	"io/ioutil"
	"os"
	"os/user"
...
func whoamiCmd(t *testing.T, uid, gid int, setgroups bool) *exec.Cmd {
	...
	cmd.SysProcAttr = &syscall2.SysProcAttr{
		Cloneflags: syscall.CLONE_NEWUSER,
		UidMappings: []syscall2.SysProcIDMap{
			{ContainerID: 0, HostID: uid, Size: 1},
		},
		GidMappings: []syscall2.SysProcIDMap{
...
func TestUnshareMountNameSpace(t *testing.T) {
	...
	cmd.SysProcAttr = &syscall2.SysProcAttr{Unshareflags: syscall.CLONE_NEWNS}
